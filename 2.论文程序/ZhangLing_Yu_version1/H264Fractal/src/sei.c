...
Boolean seiHasTemporal_reference=FALSE1;
Boolean seiHasClock_timestamp=FALSE1;
Boolean seiHasPanscan_rect=FALSE1;
Boolean seiHasBuffering_period=FALSE1;
Boolean seiHasHrd_picture=FALSE1;
Boolean seiHasFiller_payload=FALSE1;
Boolean seiHasUser_data_registered_itu_t_t35=FALSE1;
Boolean seiHasUser_data_unregistered=FALSE1;
Boolean seiHasRandom_access_point=FALSE1;
Boolean seiHasRef_pic_buffer_management_repetition=FALSE1;
Boolean seiHasSpare_picture=FALSE1;

Boolean seiHasSceneInformation=FALSE1; // JVT-D099

Boolean seiHasSubseq_information=FALSE1;
Boolean seiHasSubseq_layer_characteristics=FALSE1;
Boolean seiHasSubseq_characteristics=FALSE1;
...
void finalize_sei_message(int id)
{
  ...
  sei_message[id].available = TRUE1;
}
...
void clear_sei_message(int id)
{
  ...
  sei_message[id].available         = FALSE1;
}
...
Boolean seiHasSparePicture = FALSE1;
...
Boolean CompressSpareMBMap(unsigned char **map_sp, Bitstream *bitstream)
{
  ...
  ret = (size_compressed<size_uncompressed? TRUE1 : FALSE1);
...
Boolean seiHasSubseqInfo = FALSE1;
...
Boolean seiHasSubseqLayerInfo = FALSE1;
...
Boolean seiHasSubseqChar = FALSE1;
...
Boolean seiHasPanScanRectInfo = FALSE1;
...
void ClearUser_data_unregistered()
{
  ...
  seiHasUser_data_unregistered_info = TRUE1;
}
...
void ClearUser_data_registered_itu_t_t35()
{
  ...
  seiHasUser_data_registered_itu_t_t35_info = TRUE1;
}
...
void ClearRandomAccess()
{
  ...
  seiHasRandomAccess_info = FALSE1;
}
